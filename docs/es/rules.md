...
Una descripción de tu experiencia al crear tu entrada; 
...
Pendiente la confirmación de elegibilidad, los posibles ganadores del premio serán seleccionados por Microsoft o su Agente o un panel de jueces calificados entre todas las entradas elegibles recibidas según los siguientes criterios de evaluación: 
...
Los ganadores serán seleccionados dentro de los catorce (14) días posteriores al Período de inscripción entre todas las participaciones elegibles recibidas. En el caso de un empate entre las entradas elegibles, un juez adicional romperá el empate en función de los criterios de evaluación descritos anteriormente. Las decisiones de los jueces son definitivas y vinculantes. Si no recibimos suficientes participaciones que cumplan con los requisitos de participación, podemos, a nuestra discreción, seleccionar menos ganadores que el número de Premios del Concurso que se describe a continuación. El premio se otorgará a cada miembro del equipo, incluido el líder del equipo.

Los ganadores serán notificados a través de la información de contacto proporcionada durante la inscripción no más de siete (7) días después de la evaluación con instrucciones para reclamar el premio, incluidos los plazos de presentación. Si un ganador o líder de equipo seleccionado no puede ser contactado, no es elegible, no reclama un premio o no devuelve ningún formulario, el ganador seleccionado perderá su premio y se seleccionará un ganador alternativo si el tiempo lo permite. Si usted es un posible ganador y tiene dieciocho (18) años de edad o más, pero no ha alcanzado la mayoría de edad en su lugar de residencia legal, es posible que le solicitemos a su padre/tutor legal que firme todos los formularios requeridos en su nombre. Solo se seleccionarán tres (3) ganadores alternativos, después de lo cual los premios no reclamados permanecerán sin otorgar.
...
En la medida en que lo permita la ley, al participar, aceptas liberar y eximir de responsabilidad a Microsoft y a sus respectivas empresas matrices, socios, subsidiarias, afiliadas, empleados y agentes de toda responsabilidad o cualquier lesión, pérdida o daño de cualquier tipo que surja en relación con este Concurso o cualquier premio ganado.

Se aplican todas las leyes locales. Las decisiones de Microsoft son definitivas y vinculantes.
...
Si intentas, o tenemos motivos fundados para creer que has puesto en peligro la integridad o el funcionamiento legítimo de este Concurso mediante trampas, piratería, creación de un bot u otro programa automatizado, o mediante fraude de cualquier manera, podemos reclamarte una indemnización por daños y perjuicios con todo el peso de la ley y es posible que se le prohíba participar en futuras promociones de Microsoft.
...
Los datos personales que proporciones al participar en este Concurso serán utilizados por Microsoft y/o sus agentes y encargados de premios que actúen en nombre de Microsoft únicamente para la administración y operación de este Concurso y de acuerdo con la Declaración de Privacidad de Microsoft. 
...
Envía un correo electrónico a hacktogether@gmail.com con el asunto "Ganadores del Hackathon de Agentes de IA" dentro de los treinta (30) días posteriores al 30 de abril de 2025 para recibir una lista de los ganadores que recibieron un premio. 

## Términos y Condiciones 

En el caso de una disputa con respecto a quién envió una entrada en línea, la entrada se considerará enviada por el titular autorizado de la cuenta de la dirección de correo electrónico proporcionada en el momento de la inscripción. "Titular autorizado de la cuenta" se define como la persona física a la que se le asigna una dirección de correo electrónico por un proveedor de acceso a Internet, un proveedor de servicios en línea u otra organización que es responsable de asignar direcciones de correo electrónico para el dominio asociado con la dirección de correo electrónico enviada. Es posible que se solicite a un participante seleccionado que proporcione a los Patrocinadores una prueba de que es el titular autorizado de la cuenta de la dirección de correo electrónico asociada con la participación seleccionada. Cualquier persona que se descubra que está usando varias cuentas para ingresar será descalificada.

Los Patrocinadores se reservan el derecho, a su entera discreción, de descalificar, de este Concurso y de cualquier Concurso futuro u otra promoción realizada por los Patrocinadores, a cualquier persona que encuentren o crean que está manipulando el proceso de inscripción o el funcionamiento del Concurso o del Sitio web del Concurso; actuar en violación de las Reglas Oficiales o de manera antideportiva o disruptiva, o con la intención de molestar, abusar, amenazar o acosar a cualquier otra persona. CUALQUIER INTENTO POR PARTE DE UN PARTICIPANTE O CUALQUIER OTRA PERSONA DE DAÑAR DELIBERADAMENTE CUALQUIER SITIO WEB O SOCAVAR EL FUNCIONAMIENTO LEGÍTIMO DEL CONCURSO ES UNA VIOLACIÓN DE LAS LEYES PENALES Y CIVILES Y, EN CASO DE QUE SE REALICE DICHO INTENTO, EL PATROCINADOR SE RESERVA EL DERECHO DE RECLAMAR DAÑOS Y PERJUICIOS A DICHA PERSONA EN LA MAYOR MEDIDA PERMITIDA POR LA LEY.